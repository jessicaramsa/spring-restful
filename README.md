...
+ [Creating SSL Certificates and Keys Using openssl](https://dev.mysql.com/doc/refman/8.0/en/creating-ssl-files-using-openssl.html)
+ [CrudRepository save() method](https://www.baeldung.com/spring-data-crud-repository-save)
